...
using Register.MobileApp.Behaviors;
using Register.MobileApp.Components.Storage;
using Register.MobileApp.Controls;
using Register.MobileApp.Helpers;
using Register.MobileApp.Helpers.Data;
using Register.MobileApp.Modules;
using Register.MobileApp.Services;
using Register.MobileApp.Shell;
using Register.MobileApp.Usecase;
...
public static partial class MauiProgram
{
    ...
    private static MauiAppBuilder ConfigureGlobalSettings(this MauiAppBuilder builder)
    {
        ...
        {
            config.Converters.Add(new Register.MobileApp.Helpers.Json.DateTimeConverter());
